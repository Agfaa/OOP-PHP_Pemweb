<?php
    echo "========================================";
    echo "<br>";
    echo "Tugas PHP OOP Pemweb A";
    echo "<br>";
    echo "Agfanadita Rezkia Chaurina";
    echo "<br>";
    echo "21081010138";
    echo "<br>";
    echo "========================================";
    ...
    $CDMusic = new CDMusic ("Lagu Indonesia", 100000, 10);
    $CDMusic->setPrice(100000);
    $CDMusic->setDiscount(10);
    $CDMusic->setArtist("Mahalini");
    ...
    $CDRack = new CDRack ("Samsung Corporation", 200000, 15);
